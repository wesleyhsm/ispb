...
public class SubAcquirerCanonical implements Serializable {
	...
	public SubAcquirerCanonical() {

	}

	public SubAcquirerCanonical(String name, DocumentCanonical document, BankAccountCanonical bankAccount) {
		super();
		this.name = name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SubAcquirerCanonical other = (SubAcquirerCanonical) obj;
		if (bankAccount == null) {
